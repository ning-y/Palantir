...
public class SceneformActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    importButton.setOnClickListener(view -> {
        ...
        importIntent.setType("*/*");  // MIME type for glTF not yet supported; https://issuetracker.google.com/issues/121223582
        ...
        if (importIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(this, "Something went wrong: no resolvable activity for importIntent.", Toast.LENGTH_LONG).show();
        }
    });
  }
  ...
  private void setModelRenderable(Uri uri) {
      try {
          ...
          String cacheFileName = String.valueOf(System.currentTimeMillis()); // uri.getLastPathSegment();
